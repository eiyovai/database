...
INSERT INTO [dbo].[Activities] ([Title],[Location],[Description],[StartTime],[EndTime],[MaxParticipants],[CurrentCount],[Status],[ContactPerson],[ContactPhone],[CreatedBy]) VALUES (N'社团展示活动',N'操场',N'各大学生社团展示。','2026-06-28 09:00','2026-06-28 16:00',500,0,'open',N'系统管理员','13800138000',1);
GO
